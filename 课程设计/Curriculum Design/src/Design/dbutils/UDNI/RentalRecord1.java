...
public class RentalRecord1 {
    ...
    public RentalRecord1(String id, String powerId, String createTime, String returnTime, String duration, String amount, String status, String userId) {
        this.id = id;
